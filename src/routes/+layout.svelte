		...
		<div class="flex flex-1 items-center justify-end md:justify-between">
			<nav aria-label="Global" class="hidden md:block">
				<ul class="flex items-center gap-6 text-sm">
					...
					<li>
						<a class="text-gray-500 transition hover:text-gray-500/75" href="/github"> My Github </a>
					</li>

					<li>
						<a class="text-gray-500 transition hover:text-gray-500/75" href="/form"> Contact me </a>
					</li>
				</ul>
			</nav>
		</div>
	...
	<div class="mx-auto max-w-screen-xl px-4 py-6 sm:px-6 lg:px-8 lg:pt-16">
		...
		<div class="mt-6 border-t border-gray-100 pt-6 sm:flex sm:items-center sm:justify-center">
			...
			<ul class="flex justify-center gap-6">
				...
				<li>
					<a
						href="https://www.instagram.com/paulina.linderborg/?next=%2F"
						rel="noreferrer"
						target="_blank"
						class="text-gray-700 transition hover:opacity-75"
					>
				...
				<li>
					<a
						href="https://github.com/PauliLinde"
						rel="noreferrer"
						target="_blank"
						class="text-gray-700 transition hover:opacity-75"
					>
